...
<div class="upper-background">
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        <h1 class="interior-header">Building Materials Manufacturers</h1>
      </div>
    </div>
  </div>
</div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-xs-12">
      <h2>The Foundation of Excellent Customer Relations</h2>
      <p>When product has to go to a jobsite or distributor, we have the ability to get everything from two-by-fours to drywall sheets to shingles wherever they need to be, whenever they need to be there.</p>
    </div>
    <div class="col-xs-12 col-md-6">
      ...
      <p>By depending on AHC for all of your logistics requirements, you’re putting your trust in an experienced partner that can help you establish or maintain long-term relationships.</p>
      <p class="sign-off"><a href="contact.php">Let us know</a> about your specific requirements, and we’ll tell you how we can help.</p>
    </div>
    <div class="col-xs-12 col-md-6">
