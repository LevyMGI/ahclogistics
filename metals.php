...
<div class="upper-background">
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        <h1 class="interior-header">Metals Service Centers</h1>
      </div>
    </div>
  </div>
</div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-xs-12">
      <h2>Adding Value to Value-Added Products</h2>
      <p>In today’s JIT manufacturing world, it’s essential to have a reliable partner for shipping coils, sheet, plate and strip to meet your customers’ unforgiving production schedules.</p>
    </div>
    <div class="col-xs-12 col-md-6">
      <p>Our services include:</p>
      <ul>
        <li><span class="blue-text">></span> Finding the least expensive carriers & routes based on the specific requirements of you and your customers</li>
        <li><span class="blue-text">></span> Reserving the necessary space on a truck, train or barge</li>
        <li><span class="blue-text">></span> Preparing & filing required documentation, such as the bill of lading</li>
      </ul>
      <p>When customers have tight production deadlines, you need someone who knows how to get product from your facility or warehouse to the customer’s location on-time and intact so you can focus on your core business.</p>
      <p>At AHC Logistics, our team has been helping metals service centers remain competitive for more than 20 years.</p>
      <p class="sign-off"><a href="contact.php">Find out</a> how we can help you drive the success of your customers.</p>
    </div>
    <div class="col-xs-12 col-md-6">
